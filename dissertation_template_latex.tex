...
\setsubsubsecheadstyle{\bfseries \itshape}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
\input{chapter1}                     %<Insert your chapters here; I recommend to use
\input{chapter2}                     %   \include rather than \input for chapters
\input{chapter3}
\input{chapter4}
\input{chapter5}
...
%\addcontentsline{toc}{part}{Chapter}    % Add "Chapter" to TOC here at 'part' level
%\phantomsection                                       %   bookmark more accurately
 \addtocontents{toc}%                    % Add this 'mark' to TOC so subsequent pages use
  {\protect\markboth{CHAPTER}{Page}}%~Add "Appendix" to TOC here; comment out this
...
\input{appendix2}  
 %   \input rather than \include for appendices.
